...
- [GMSA](./gmsa.md): describes how to provision a Rancher environment for testing the [Rancher CCGRKC Plugin](https://github.com/rancher/Rancher-Plugin-gMSA), including provisioning an Active Directory instance and an RKE2 cluster
