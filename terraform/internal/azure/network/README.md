...
This [Terraform](https://www.terraform.io/) module spins up a VPC, subnet(s), and a Network Security Group (with a predefined set of rules from [`terraform/internal/rancher/network`](../../rancher/network/)) in Azure.
