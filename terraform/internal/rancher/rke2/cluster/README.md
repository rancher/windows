# Rancher RKE2 Cluster Terraform

This [Terraform](https://www.terraform.io/) module creates a `provisioning.cattle.io/v1` [custom RKE2 cluster]((../../docs/general/types_of_rancher_clusters.md)) in a Rancher instance.
